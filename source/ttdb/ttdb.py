...
ttdb_array_iter__close = ttdb_func("ttdb_array_iter__close", None,
                                   (ttdb_array_iter_t,))
ttdb_array_iter__next = ttdb_func("ttdb_array_iter__next", ttdb_array_t,
                                  (ttdb_array_iter_t,))
...
ttdb_dataset__num_arrays = ttdb_func("ttdb_dataset__num_arrays", c_uint64,
                                     (ttdb_dataset_t,))
ttdb_dataset__find_array = ttdb_func("ttdb_dataset__find_array", ttdb_array_t,
                                     (ttdb_dataset_t, c_char_p))
ttdb_dataset__arrays = ttdb_func("ttdb_dataset__arrays", ttdb_array_iter_t,
                                 (ttdb_dataset_t,))
...
ttdb_time_step__close = ttdb_func("ttdb_time_step__close", None,
                                  (ttdb_time_step_t,))
ttdb_time_step__time = ttdb_func("ttdb_time_step__time", c_double,
                                 (ttdb_time_step_t,))
ttdb_time_step__uniforms = ttdb_func("ttdb_time_step__uniforms", ttdb_dataset_t,
                                     (ttdb_time_step_t,))
ttdb_time_step__varyings = ttdb_func("ttdb_time_step__varyings", ttdb_dataset_t,
                                     (ttdb_time_step_t,))
...
ttdb_time_step_iter__close = ttdb_func("ttdb_time_step_iter__close", None,
                                       (ttdb_time_step_iter_t,))
ttdb_time_step_iter__next = ttdb_func("ttdb_time_step_iter__next",
                                      ttdb_time_step_t,
                                      (ttdb_time_step_iter_t,))
...
ttdb_series__num_time_steps = ttdb_func("ttdb_series__num_time_steps", c_uint64,
                                        (ttdb_series_t,))
ttdb_series__last_time_step = ttdb_func("ttdb_series__last_time_step",
                                        ttdb_time_step_t, (ttdb_series_t,))
ttdb_series__time_steps = ttdb_func("ttdb_series__time_steps",
                                    ttdb_time_step_iter_t, (ttdb_series_t,))
...
ttdb_series_iter__next = ttdb_func("ttdb_series_iter__next", ttdb_series_t,
                                   (ttdb_series_iter_t,))
ttdb_series_iter__close = ttdb_func("ttdb_series_iter__close", None,
                                    (ttdb_series_iter_t,))

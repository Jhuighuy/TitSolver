...
from typing import Any, Final, Callable, NewType
import numpy as np
...
class Library:
  ...
  def __init__(self) -> None:
    self._dll = CDLL(os.path.dirname(__file__) + "/libttdb.so")
...
ttdb_type__kind: Final[Callable[[ttdb_type_t], bytes]]
ttdb_type__kind = lib.func("ttdb_type__kind", (c_uint32,), c_char_p)
ttdb_type__rank: Final[Callable[[ttdb_type_t], int]]
ttdb_type__rank = lib.func("ttdb_type__rank", (c_uint32,), c_uint32)
ttdb_type__dim: Final[Callable[[ttdb_type_t], int]]
ttdb_type__dim = lib.func("ttdb_type__dim", (c_uint32,), c_uint32)
...
ttdb_array__close: Final[Callable[[ttdb_array_t], None]]
ttdb_array__close = lib.func("ttdb_array__close", (c_void_p,), None)
ttdb_array__name: Final[Callable[[ttdb_array_t], bytes]]
ttdb_array__name = lib.func("ttdb_array__name", (c_void_p,), c_char_p)
ttdb_array__size: Final[Callable[[ttdb_array_t], int]]
ttdb_array__size = lib.func("ttdb_array__size", (c_void_p,), c_uint64)
ttdb_array__type: Final[Callable[[ttdb_array_t], ttdb_type_t]]
ttdb_array__type = lib.func("ttdb_array__type", (c_void_p,), ttdb_type_t)
ttdb_array__read: Final[Callable[[ttdb_array_t, c_void_p], None]]
ttdb_array__read = lib.func("ttdb_array__read", (c_void_p, c_void_p), None)
...
class Array:
  ...
  def data(self) -> NDArray[Any]:
    ...
    array = np.empty(shape, dtype=self.type.kind.to_numpy())  # type: ignore
    self.read(array.ctypes.data)  # type: ignore
    return array  # type: ignore

ttdb_array_iter_t = NewType("ttdb_array_iter_t", c_void_p)
ttdb_array_iter__close: Final[Callable[[ttdb_array_iter_t], None]]
ttdb_array_iter__close = lib.func("ttdb_array_iter__close", (c_void_p,), None)
ttdb_array_iter__next: Final[Callable[[ttdb_array_iter_t], ttdb_array_t | None]]
ttdb_array_iter__next = lib.func("ttdb_array_iter__next", (c_void_p,), c_void_p)
...
ttdb_dataset__close: Final[Callable[[ttdb_dataset_t], None]]
ttdb_dataset__close = lib.func("ttdb_dataset__close", (c_void_p,), None)
ttdb_dataset__num_arrays: Final[Callable[[ttdb_dataset_t], int]]
ttdb_dataset__num_arrays = lib.func("ttdb_dataset__num_arrays", (c_void_p,),
                                    c_uint64)
ttdb_dataset__find_array: Final[Callable[[ttdb_dataset_t, bytes],
                                         ttdb_array_t | None]]
ttdb_dataset__find_array = lib.func("ttdb_dataset__find_array",
                                    (c_void_p, c_char_p), c_void_p)
ttdb_dataset__arrays: Final[Callable[[ttdb_dataset_t], ttdb_array_iter_t]]
ttdb_dataset__arrays = lib.func("ttdb_dataset__arrays", (c_void_p,), c_void_p)
...
ttdb_time_step__close: Final[Callable[[ttdb_time_step_t], None]]
ttdb_time_step__close = lib.func("ttdb_time_step__close", (c_void_p,), None)
ttdb_time_step__time: Final[Callable[[ttdb_time_step_t], float]]
ttdb_time_step__time = lib.func("ttdb_time_step__time", (c_void_p,), c_double)
ttdb_time_step__uniforms: Final[Callable[[ttdb_time_step_t], ttdb_dataset_t]]
ttdb_time_step__uniforms = lib.func("ttdb_time_step__uniforms", (c_void_p,),
                                    c_void_p)
ttdb_time_step__varyings: Final[Callable[[ttdb_time_step_t], ttdb_dataset_t]]
ttdb_time_step__varyings = lib.func("ttdb_time_step__varyings", (c_void_p,),
                                    c_void_p)
...
ttdb_time_step_iter__close: Callable[[ttdb_time_step_iter_t], None]
ttdb_time_step_iter__close = lib.func("ttdb_time_step_iter__close", (c_void_p,),
                                      None)
ttdb_time_step_iter__next: Callable[[ttdb_time_step_iter_t],
                                    ttdb_time_step_t | None]
ttdb_time_step_iter__next = lib.func("ttdb_time_step_iter__next", (c_void_p,),
                                     c_void_p)
...
ttdb_series__close: Final[Callable[[ttdb_series_t], None]]
ttdb_series__close = lib.func("ttdb_series__close", (c_void_p,), None)
ttdb_series__num_time_steps: Final[Callable[[ttdb_series_t], int]]
ttdb_series__num_time_steps = lib.func("ttdb_series__num_time_steps",
                                       (c_void_p,), c_uint64)
ttdb_series__last_time_step: Final[Callable[[ttdb_series_t], ttdb_time_step_t]]
ttdb_series__last_time_step = lib.func("ttdb_series__last_time_step",
                                       (c_void_p,), c_void_p)
ttdb_series__time_steps: Final[Callable[[ttdb_series_t], ttdb_time_step_iter_t]]
ttdb_series__time_steps = lib.func("ttdb_series__time_steps", (c_void_p,),
                                   c_void_p)
...
ttdb_series_iter__next: Final[Callable[[ttdb_series_iter_t],
                                       ttdb_series_t | None]]
ttdb_series_iter__next = lib.func("ttdb_series_iter__next", (c_void_p,),
                                  c_void_p)
ttdb_series_iter__close: Final[Callable[[ttdb_series_iter_t], None]]
ttdb_series_iter__close = lib.func("ttdb_series_iter__close", (c_void_p,), None)
...
ttdb__close: Final[Callable[[ttdb_t], None]]
ttdb__close = lib.func("ttdb__close", (c_void_p,), None)
ttdb__open: Final[Callable[[bytes], ttdb_t]]
ttdb__open = lib.func("ttdb__open", (c_char_p,), c_void_p)
ttdb__num_series: Final[Callable[[ttdb_t], int]]
ttdb__num_series = lib.func("ttdb__num_series", (c_void_p,), c_uint64)
ttdb__last_series: Final[Callable[[ttdb_t], ttdb_series_t]]
ttdb__last_series = lib.func("ttdb__last_series", (c_void_p,), c_void_p)
ttdb__series: Final[Callable[[ttdb_t], ttdb_series_iter_t]]
ttdb__series = lib.func("ttdb__series", (c_void_p,), c_void_p)
...
class Storage:
  ...
  def __init__(self, path: str) -> None:
    """Open the storage with the given path."""

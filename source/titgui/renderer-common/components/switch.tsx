...
export function Switch({
  ...
  return (
    ...
    >
      <BaseSwitch.Thumb className="block h-3 w-3 translate-x-0.5 rounded-full bg-(--bg-2) shadow-sm transition-transform data-checked:translate-x-3 data-checked:bg-(--bg-3)" />
    </BaseSwitch.Root>
  );
}

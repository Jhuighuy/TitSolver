  ...
  return (
    <Flex direction={sideToFlexDirection(side)}>
      ...
      <Flex
        ...
        className="bg-gradient-to-r from-gray-50 to-gray-100 dark:bg-gradient-to-bl dark:from-gray-700 dark:to-gray-800  inset-shadow-sm inset-shadow-gray-700"
      >
        {/* ---- Item groups. ---------------------------------------------- */}
      ...
      {activeItem !== -1 && (
        <Resizable side={side} size={size} setSize={setSize}>
          <Flex
            ...
            height="100%"
            direction="column"
            className="bg-gray-100 dark:bg-gradient-to-bl dark:from-gray-700 dark:to-gray-800 inset-shadow-sm inset-shadow-gray-700"
          >
            {/* ---- Header. ----------------------------------------------- */}

...
from pytit.data import Series, Storage, TimeStep, to_numpy
...
class TitDatabaseReader(VTKPythonAlgorithmBase):
    ...
    def RequestData(self, request, inInfo, outInfo) -> bool:
        ...
        arrays = {
            "r": to_numpy(time_step.varyings.find_array("r")),
            "v": to_numpy(time_step.varyings.find_array("v")),
            "rho": to_numpy(time_step.varyings.find_array("rho")),
            # name: array.data

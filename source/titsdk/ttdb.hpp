 ...
 * @returns Pointer to a null-terminated string containing the kind of the
 *          type. The string points to an internal buffer, so it should not be
 *          freed.
 */
 ...
 *
 * @param iter Iterator to get the next array from.
 * @returns Pointer to the next array from the iterator. If there are no more
 *          arrays, returns null.
 */
 ...
 *
 * @param iter Iterator to get the next time step from.
 * @returns Pointer to the next time step from the iterator. If there are no
 *          more time steps, returns null.
 */
 ...
 *
 * @param iter Iterator to get the next series from.
 * @returns Pointer to the next series from the iterator. If there are no more
 *          series, returns null.
 */

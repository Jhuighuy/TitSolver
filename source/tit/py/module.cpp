...
public:
  ...
  static auto emplace(const char* name) -> PyModuleDef& {
...
private:
  ...
  static std::forward_list<PyModuleDef> defs_;

}; // class ModuleDefs

std::forward_list<PyModuleDef> ModuleDefs::defs_;
...
Module::Module(const char* name)
    : Object{ensure(PyModule_Create(&ModuleDefs::emplace(name)))} {}

...
[[gnu::noinline]] void func_3() {
  ...
  Std::println("func_3");
  std::this_thread::sleep_for(10ms); // NOLINT(*-include-cleaner)
}
...
[[gnu::noinline]] void func_2() {
  ...
  std::this_thread::sleep_for(20ms); // NOLINT(*-include-cleaner)
}
...
[[gnu::noinline]] void func_1() {
  ...
  std::this_thread::sleep_for(40ms); // NOLINT(*-include-cleaner)
}

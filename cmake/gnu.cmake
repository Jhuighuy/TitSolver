...
if(APPLE)
  list(
    ...
    # macOS version reported by `sysctlbyname("kern.osproductversion")` crashing
    # Qt WebEngine (it can be fixed by `SYSTEM_VERSION_COMPAT=0`, however,
    # Chrome cannot access OpenGL properly, so I am assuming there is much more
    # than just version information).

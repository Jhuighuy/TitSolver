...
find_program(CLANG_TIDY_EXE NAMES "clang-tidy-23" "clang-tidy")
...
function(write_compile_flags TARGET)
  ...
  set(FLAGS_FILE "${TARGET_BINARY_DIR}/${TARGET}_compile_flags.txt")
  ...
  add_custom_command(
    ...
    COMMAND
      "${CMAKE_COMMAND}" -E create_symlink "${FLAGS_FILE}" "${FLAGS_SYMLINK}"
    COMMAND_EXPAND_LISTS # Needed for generator expressions to work.
    VERBATIM
  )
